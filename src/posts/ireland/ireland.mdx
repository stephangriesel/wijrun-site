...
<Accordion
  ...
  content="
<ul>
  <li>Travelodge Dublin Airport South 82,80 euro (Thursday Evening)</li>
  <li>Closest accommodation to the airport we could find as we arrived late. Basic hotel. The area seemed a bit industrial but was easy to catch a bus from there to Dublin!</li>
  <li>Clarion Hotel Dublin Liffey Valley 109 euro (Friday Evening)</li>
  <li>A bit out of town, in fact perhaps too much if you are visiting Dublin. But for us ideal as we did the parkrun which was around the corner. Als the hotel was lovely! And much cheaper than staying in Dublin and the people once again super friendly! They even let stevie have seconds on breakfast two hours later!</li>
  <li>Barnacles Temple Bar House 155 euro (Saturday Evening). In the hustle and bustle of Temple Bar street right next to the famous Temple Bar. Friendly people working at the hostel, tiny rooms and noisy, but we enjoyed it nonetheless!</li>
</ul>
"
/>
...
<p>
<ul>
  <li>Scheduled for 10:45pm actual departure close to 11pm</li>
  <li>Flight arrival in Dublin: Arrived at 11:20pm I think was at hotel just after 12</li>
  <li>Ryanair is cheap for a reason because its shit and not on time.</li>
  <li>Taxi from Dublin airport to Travelodge Dublin Airport South super easy to get a taxi, tried to get an Uber but could not find the guy. 16,6euro for trip</li>
</ul>
<p>
...
<p>
<ul>
  <li>Bus number 4 Monktown stopped in City Centre, hopped off at O’ Donnel for both of us 5,40euro</li>
  <li>Bus to clarion hotel 5,40 for both of us</li>
  <li>Bus from parkrun back to hotel 5,40</li>
  <li>Bus to airport 7euro each (Tip: look for the air coach signs at bus stops if you want to go to airport)</li>
</ul>
"
/>
...
<Accordion
  title="What we saw"
  content="
  <p>Cliffs of moher 90euro bought tix online from Get your guide (Get your guide is great service, had to cancel the airlink I bought due to change in plans and the almost immediately refunded me!)</p>
  <p>Ferry to cliffs 5euro (actually a fishing boat converted into a sightsee boat but still with the effect of motion sickness)</p>
  <p>Books of kells 11euro each, the books of kells are the latin first 4 chapters of the new testament, but to be honest I was way more interested in the library because the library in Harry Potter was bases on it!</p>
"
/>
...
<ul>
  <li>
    <strong>Distance:</strong> 5.01km
  </li>
  <li>
    <strong>Elevation:</strong> 48m
  </li>
  <li>
    <strong>Time:</strong> 24,25min
  </li>
  <li>
    <strong>Difficulty:</strong> Easy
  </li>
  <li>
    <strong>Scenic:</strong> Yes
  </li>
  <li>
    <strong>Route description:</strong> Flat, scenic and fun local people
  </li>
  <li>
    <strong>Start / Finish:</strong> Griffeen Parkrun
  </li>
</ul>
" />
