...
<div className="post-video">
  <iframe
    width="100%"
    height="auto"
    src="https://www.youtube.com/embed/fIPG2PHvKZs"
    frameborder="0"
...
<Accordion
  title="Accommodation"
  content="
  <p>Calm Hotel Euro 48 plus Euro 1 tourist tax</p>
  <p>Ideal location</p>
  <p>10min walk from Europe station</p>
  <p>The room is tiny, but the furnishings and bedding is of high quality.</p>
  <p>You can hear your neighbour. But I mean you get what you pay. I am not a light sleeper so it was good.</p>
"
/>
...
<Accordion
  title="Travel"
  content="
  <p>Amsterdam Centraal Thalys to Lille Europe 20euro (20th anniversary special)</p>
  <p>Lille Europe- Amsterdam Centraal Thalys €50</p>
  <ul>
  <li><strong>Departure:</strong> 28th 07:17 Arrival 9:52</li>
  <li><strong>Return:</strong> 29th 11:59 Arrival 14:42</li>
  <ul>
"
/>
...
<Accordion
  ...
  content="
  <ul>
  <li>Palais des beaux arts where Zep was also exhibiting. This was pretty cool, next to very serious art for example Jesus Christening Zep’s illustrations and interpretations are shown and are vary satirical. Really enjoyed that in the museum.</li>
  <li>Grand Place</li>
  <li>Walked past the Hospice</li>
  <li>Rue de Bethune (Did the usual tourist shopping at H&M)</li>
  <ul>
"
/>
...
<Accordion
  ...
  <p>
    ...
    <ul>
      <li>Cappuccino and Brownie at Omega Son €5,40</li>
      <li>Cured Meat Natural and Chorizo at Du Barbier €3,60</li>
      <li>Chicken Sandwich and Water at Palais des beaux arts €8,80</li>
      <li>Pepsi at the Rue (Can you believe this!) €4,30</li>
      <li>Cheese burger and two beers at the Buffalo Burger €13,90</li>
    </ul>
  </p>
  <p>
    <strong>Sunday:</strong>
    <ul>
      <li>Meert Safari delicacy: €4,50</li>
      <li>Panini and Water at Costa €7,10</li>
      <li>Average daily spend per person: €36</li>
    </ul>
  </p>
"
/>
...
<Accordion
  ...
  content="
  <p>I joined the Runkeeper Global 5km challenge</p>
  <ul>
  <li>
    <strong>Distance:</strong> 5.66km
  </li>
  <li>
    <strong>Elevation:</strong> 46m
  </li>
  <li>
    <strong>Time:</strong> 38min47seconds
  </li>
  <li>
    <strong>Difficulty:</strong> Easy
  </li>
  <li>
    <strong>Scenic:</strong> Not as much!
  </li>
  <li>
    <strong>Route description:</strong> Flat. Will see Grand Place, Le Bloempot, Meert, Porte de Paris, Gare Lille Flanders, the old stock exchange.
  </li>
  <li>
    <strong>Other comments:</strong> You’ll essentially just run past the same things you saw on your trip.
  </li>
  <li>
    <strong>Start / Finish:</strong> Calm Hotel
  </li>
</ul>
"
/>
