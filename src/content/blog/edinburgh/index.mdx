...
draft: false
gpx_file: img/activity_21347072680.gpx
---
**Day 1:**
...
<p>The Roseate</p>
<p>
<strong>Cost: </strong>€668<br/>
<p>We booked this through <a href='https://luxuryescapes.com/refer/INVITESTEPHANJ7M1P4?utm_campaign=default-referral-campaign&utm_source=luxuryescapes&utm_medium=referral&utm_content=referrer%3Af61697ed-0cbf-4e3a-8b29-2e84862bbf9e'>Luxury Escapes</a>. The extra benefits are great!</p>
"
/>
<Accordion
  title="Travel"
...
<p>KLM Flight</p>
<p>
<strong>Cost:</strong> €586<br/>
<p>Last minute booking 😖</p>
"
/>

<Accordion title="What we saw in Edinburgh"
  content="

  <ul>
  <strong>Day 1:</strong>
  <li>Tourist Bar (Casserole & Steak Ale Pie)</li>
  </ul><br/>
  <ul>
  <strong>Day 2:</strong>
  <li>Town Walk & The Castle</li>
  <li>Lunch at Outsiders & Holyrood Gardens</li>
  <li>Dinner at Fava</li>
  </ul><br/>
  <ul>
  <strong>Day 3:</strong>
  <li>Run to Cramond (14km)</li>
  <li>River Leith Walk to Stockbridge</li>
  <li>Dinner Patatino</li>
  </ul><br/>
  <ul>
  <strong>Day 4:</strong>
  <li>Arthur's Seat Hike</li>
  <li>Mary's Close Tour</li>
  <li>White Inn Pub</li>
  <li>Dinner at The Witchery</li>
  </ul><br/>
  <ul>
  <strong>Day 5:</strong>
  <li>Relaxed Morning & Breakfast</li>
  </ul>
"
/>
...
<Accordion
  ...
  <ul>
  <strong>Day 1:</strong>
  <li>The Tourist Bar (Steak & Ale Pie)</li>
  </ul></br>
  <ul>
  <strong>Day 2:</strong>
  <li>Outsiders (Lunch)</li>
  <li>Fava (Early Dinner)</li>
  </ul></br>
  <ul>
  <strong>Day 3:</strong>
  <li>Patatino</li>
  ...
  <ul>
  <strong>Day 4:</strong>
  <li>White Inn (Oldest Pub)</li>
  <li>Aboosh (Takeaway)</li>
  <li>The Witchery (Final Dinner)</li>
  </ul>
"
/>
...
<Accordion
  ...
  <p>Run to Cramond. It an easy route from Roseate as you just get on the Roseburn path and follow path all the way to Cramond, see GPX.</p>
"
/>

import GpxMap from '../../../components/GpxMap.jsx';
import gpxUrl from './activity_21347072680.gpx?url';

<GpxMap src={gpxUrl} client:only="react" />
